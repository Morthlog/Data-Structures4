...
//  * @author uday
//  */
// public class IntIntLRUCache<K, V> implements Cache<K, V> {
...
//     private long misses = 0, hits=0, lookups=0;
//     static {
...
//                 V previousValue = (V) data[currentPosition + VALUE_OFFSET];
...
//                 removeEntry(currentPosition);
//                 addEntry(currentPosition);
//                 return (V)data[currentPosition + VALUE_OFFSET];
//             }
//             currentPosition = (currentPosition + NUM_INTEGERS_TO_HOLD_ENTRY) & positionModulo;
//         } while (currentPosition != position);
//         return null;
...
//             }
//             if (key == data[currentPosition + KEY_OFFSET]) {
//                 V removedValue = (V)data[currentPosition + VALUE_OFFSET];
//                 removeEntry(currentPosition);
...
//                     return;
//                 }
//                 currentKeySlot = hash((K)data[currentPosition + KEY_OFFSET]);
...
//             if ((int)data[currentPosition + LEFT_OFFSET] >= 0) {
//                 data[(int)data[currentPosition + LEFT_OFFSET] + RIGHT_OFFSET] = freeSlot;
//                 if (currentPosition == tailPosition) {
//                     tailPosition = freeSlot;
//                 }
//             }
//             if ((int)data[currentPosition + RIGHT_OFFSET] >= 0) {
//                 data[(int)data[currentPosition + RIGHT_OFFSET] + LEFT_OFFSET] = freeSlot;
...
//         if ((int)data[position + LEFT_OFFSET] >= 0) {
//             data[(int)data[position + LEFT_OFFSET] + RIGHT_OFFSET] = data[position + RIGHT_OFFSET];
//         } else {
//             headPosition = (int)data[position + RIGHT_OFFSET];
//         }
//         if ((int)data[position + RIGHT_OFFSET] >= 0) {
//             data[(int)data[position + RIGHT_OFFSET] + LEFT_OFFSET] = data[position + LEFT_OFFSET];
//         } else {
//             tailPosition = (int)data[position + LEFT_OFFSET];
//         }
//     }
...
//         int h = key.hashCode() * 0x9E3779B9; // phiMix(x) taken from FastUtil
